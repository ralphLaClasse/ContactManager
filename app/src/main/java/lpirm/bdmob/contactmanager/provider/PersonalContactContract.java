package lpirm.bdmob.contactmanager.provider;
...
public final class PersonalContactContract implements DatabaseConstants {
	 ...
	 */
	public static final String AUTHORITY = "lpirm.bdmob.contactmanager.provider";
	...
	public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + 
			"/vnd.lpirm.bdmob.contactmanager.provider.table";
	/**
	 * The mime type of a single item.
	 */
	public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + 
			"/vnd.lpirm.bdmob.contactmanager.provider.table_item";
